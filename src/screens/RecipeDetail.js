...
const RecipeDetail = ({ route }) => {
  ...
  return (
    ...
    >
      ...
      {/* ✅ 이미지 */}
      <Image 
        source={{ uri: recipe.imageUrls?.length > 0 ? recipe.imageUrls[0] : getDefaultImageUrl(recipe.category) }}
...
const styles = StyleSheet.create({
  ...
  recipeImage: { width: "100%", height: 200, borderRadius: 10, backgroundColor: "#eee", marginBottom: 15 },
  description: { fontSize: 16, color: "#666", marginBottom: 15 },
  actionsContainer: { flexDirection: "row", justifyContent: "center", marginVertical: 10 },
  actionButton: { flexDirection: "row", alignItems: "center", marginHorizontal: 15 },
  actionText: { fontSize: 16, marginLeft: 5, color: "#444" },
  ...
  listItem: { fontSize: 16, paddingVertical: 3, color: "#444" },
});
